...
@Database(entities = {Tema.class, Pregunta.class, Favorito.class, RankPregunta.class, Respuesta.class, RankRespuesta.class}, version = 13, exportSchema = false)
public abstract class ForoGeneralDatabase extends RoomDatabase
{
    ...
    public abstract RankRespuestaDao rankRespuestaDao();
