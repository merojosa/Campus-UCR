...
public class SodaMapActivity extends AppCompatActivity implements PermissionsListener {
    ...
    private void getRoute(MapboxMap mapboxMap, Point origin, Point destination) {
        ...
        client.enqueueCall(new Callback<DirectionsResponse>() {
            ...
            public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                ...
                Toast.makeText(SodaMapActivity.this, String.format(
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                ...
                Toast.makeText(SodaMapActivity.this, "Error: " + throwable.getMessage(),
    ...
    private void buildAlertMessageNoGps() {
        ...
        builder.setMessage("GPS deshabilitado, ¿desea habilitarlo?")
                .setCancelable(false)
