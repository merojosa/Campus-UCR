...
// Referencia: https://docs.mapbox.com/android/maps/examples/location-picker/
public class OrderLocationActivity extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback
{
    ...
    {
        OrderLocationActivity.this.mapboxMap = mapboxMap;
        mapboxMap.setStyle(Style.MAPBOX_STREETS, style ->
        {
            ...
            hoveringMarker = new ImageView(OrderLocationActivity.this);
            hoveringMarker.setImageResource(R.drawable.marcador_blanco);
