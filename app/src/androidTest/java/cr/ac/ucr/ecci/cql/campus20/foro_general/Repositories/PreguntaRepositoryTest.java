...
public class PreguntaRepositoryTest {
    ...
    private static Pregunta PREGUNTA_PRUEBA = new Pregunta(0, USUARIO_PREGUNTA_PRUEBA, TEMA_ID1, TEXTO_PREGUNTA_PRUEBA, LIKES_PREGUNTA_PRUEBA, DISLIKES_PREGUNTA_PRUEBA);
    private static Pregunta PREGUNTA_PRUEBA2 = new Pregunta(0, USUARIO_PREGUNTA_PRUEBA2, TEMA_ID2, TEXTO_PREGUNTA_PRUEBA2, LIKES_PREGUNTA_PRUEBA2, DISLIKES_PREGUNTA_PRUEBA2);
