...
public class PreguntaDaoTest {
    ...
    private static Pregunta PREGUNTA_PRUEBA = new Pregunta(0, USUARIO_PREGUNTA_PRUEBA, TEMA_ID_PREGUNTA_PRUEBA, TEXTO_PREGUNTA_PRUEBA, LIKES_PREGUNTA_PRUEBA, DISLIKES_PREGUNTA_PRUEBA, 0);
    private static Pregunta PREGUNTA_PRUEBA2 = new Pregunta(0, USUARIO_PREGUNTA_PRUEBA2, TEMA_ID_PREGUNTA_PRUEBA2, TEXTO_PREGUNTA_PRUEBA2, LIKES_PREGUNTA_PRUEBA2, DISLIKES_PREGUNTA_PRUEBA2, 0);
